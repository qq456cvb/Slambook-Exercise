...
int main( int argc, char** argv )
{
    ...
    // hat 为向量到反对称矩阵
    cout << "so3 hat=\n" << endl << Sophus::SO3d::hat(so3)<<endl;
    // 相对的，vee为反对称到向量
    cout << "so3 hat vee= " << endl << Sophus::SO3d::vee( Sophus::SO3d::hat(so3) ).transpose()<<endl; // transpose纯粹是为了输出美观一些
    ...
    cout<<"se3 = "<<endl << se3.transpose()<<endl;
